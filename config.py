...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6872968794').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "DK_FILESTORE_BOT") # without @
